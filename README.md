...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ddp6cy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ddp6cy.containers.anotherwebservice.com/
...
```
git clone git@github.com:adiprasetyaxyz/container-ddp6cy.git
cd container-ddp6cy
```
...
```
docker attach container-ddp6cy
```
